...
public class ScheduleFragment extends Fragment {
    ...
    static ScheduleFragment newInstance(int page, int current_year, boolean current_year_leap) {
        ScheduleFragment pageFragment = new ScheduleFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.schedule_fragment_layout, null);
